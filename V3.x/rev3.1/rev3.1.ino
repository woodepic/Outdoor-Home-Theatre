...
#define heaterTime 45000
#define fansTime 300000
...
class ThermalControl {
  public:
      ...
      void printStateData() {
        ...
        switch (State) {
          case coolHigh:
            Serial.print("coolHigh");
            break;
          case coolLow:
            Serial.print("coolLow");
            break;
          case heating:
      ...
      void plotTempData() {
        ...
        //plot the int of what state we're on
        Serial.print("State:");
...
void setup() {
  ...
  //Initialize relays to be off (high is off)
  pinMode(ac, OUTPUT);
  digitalWrite(ac, HIGH);
